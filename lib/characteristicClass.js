...
class characteristic extends EventEmitter{
    ...
    _UserDescription(){
        var descUUID = '00002901-0000-1000-8000-00805f9b34fb'  //https://www.bluetooth.com/specifications/gatt/viewer?attributeXmlFile=org.bluetooth.descriptor.gatt.characteristic_user_description.xml
        var descName = 'desc0'
        ...
        this.userDescription_iface = {
            ...
            UUID: descUUID,
            Characteristic: this.servicePath + '/' + this.node,

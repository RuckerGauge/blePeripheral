...
class characteristic extends EventEmitter{
    ...
    _descriptorUserDescription(){
        ...
        console.log('Exporting D-Bus interface for ' + this.userDescription_iface.Characteristic + ' Characteristic User Description.');
    ...
    _descriptorCharacteristicFormat(){
        ...
        console.log('Exporting D-Bus interface for ' + this.userDescription_iface.Characteristic + ' Characteristic Presentation Format.');
        this.DBus.exportInterface(this.userDescription_iface, this.iface.Service + '/' + this.node + '/' + descName, this.userDescription_ifaceDesc);
    }

...
class characteristic extends EventEmitter{
    constructor(dbus, sPath, UUID, node, flags, logIO = false){
        ...
        this.valueFormat = Buffer.from([0x25, 0x00, 0x00, 0x27, 0x00, 0x00, 0x00]);
        ...
        console.log('adding UserDescription...');
    ...
    _descriptorCharacteristicFormat(){
        var descUUID = '2904-0000-1000-8000-00805f9b34fb'  //https://www.bluetooth.com/specifications/gatt/viewer?attributeXmlFile=org.bluetooth.descriptor.gatt.characteristic_user_description.xml

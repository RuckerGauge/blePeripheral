...
class characteristic extends EventEmitter{
    constructor(DBusService = Dbus.registerService('system', 'com.netConfig') , sPath = '/com/netConfig', UUID, node, flags, logIO = false){
        ...
        this._iface2.addSignal('PropertiesChanged', {
            types: [
                ...
                {type: 'sa{sv}', name: 'changed_properties'},
    ...
    notify(valAsBuffer = this.iface.Value){
        ...
        // signal time=1589381349.068825 sender=:1.338 -> destination=(null destination) serial=19 path=/com/sampleApp/cpuTemp; interface=org.freedesktop.DBus.Properties; member=PropertiesChanged
        // string "org.bluez.GattCharacteristic1"
        // array [
        //    dict entry(
        //       string "Value"
        //       variant             array of bytes [
        //             31 30 31 2e 32 35 c2 b0 46
        //          ]
        //    )
        // ]

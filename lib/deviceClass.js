...
class device{
  ...
  setBooleanProperty(propertyName = 'Trusted', value = true, objectPath = '/org/bluez/hci0/dev_00_DB_70_C8_0C_7F'){
    ...
    let rsltObj = '';
    try{
      rsltObj = cp.execSync('/usr/bin/gdbus call --system --dest org.bluez --object-path '+ objectPath +' --method org.freedesktop.DBus.Properties.Set org.bluez.Device1 ' + propertyName + ' ' + value );
    } catch(err){

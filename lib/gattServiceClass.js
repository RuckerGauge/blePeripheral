...
class gattService{
  ...
  createObjManagerIface(characteristics = []){   
    ...
    } //a{sa{sv}} and a{sa{sa{sv}}} both worked

    // objectDescription = { 
    //   "/org/bluez/18508/bluez/dev_5C_F3_70_67_E2_6F/service0": {
    //     "org.bluez.GattService1": { 
    //       "UUID":"13333333-3333-3333-3333-333333333333", "Primary":true, "Characteristics":[
    //         "/org/bluez/18508/bluez/dev_5C_F3_70_67_E2_6F/service0/char0"
    //       ] 
    //     } 
    //   } 
    // }
    ...
    // objectDescription = { "src":'/com/sampleApp'} //a{sv}
    // objectDescription = ["org.bluez.GattService1",[["prmary", true],["service",["O", "/COM/SAMPLE"]]]]

    // objectDescription = "'org.bluez.GattService1':{'Primary': true,'UUID': '27b5244f-94f3-4011-be53-6ac36bf22cf1'}"
    ...
    this._iface_OM.addMethod('GetManagedObjects', {out: {type: 'a{oa{sa{sv}}}', name: 'object_path'}}, (cback)=>{

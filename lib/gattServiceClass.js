 ...
 */
class gattService{
  constructor(DBusClient = Dbus.getBus('system'), DBusService = Dbus.registerService('system', 'com.netConfig'), sPath = "/com/netConfig",  UUID = "5a0379a8-d692-41d6-b51a-d1730ea6b9d6", ){
    this.DBusOld = {};
        ...
        iface.RegisterApplication('/com/sampleApp', [], (err, result)=>{
          if(err){
            ...
            console.error('Error registerGattService, RegisterApplication method.', err);
              ...
              logit('looks like we got the noreplay error');

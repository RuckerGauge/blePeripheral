...
class gattService{
  ...
  createObjManagerIface(characteristics = []){   
    ...
    characteristics.forEach(function(char){
      ...
      objectDescription.push([_serviceNode+"/"+_node+"/userDescription",[["org.bluez.GattDescriptor1",[["UUID",["s","00002901-0000-1000-8000-00805f9b34fb"]],["Characteristic",["o",_serviceNode+"/"+_node]]]]]]);
    });

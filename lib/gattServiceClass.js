const Characteristics =    require("./lib/characteristicClass.js");
...
class gattService{
  ...
  createObjManagerIface(characteristics = [Characteristics]){   
    ...
    characteristics.forEach(function(char){
      ...
      objectDescription.push([_serviceNode+"/"+_node+"/description",[["org.bluez.GattDescriptor1",[["UUID",["s","00002901-0000-1000-8000-00805f9b34fb"]],["Characteristic",["o",_serviceNode+"/"+_node]],["Flags",["as",[["read"]]]]]]]]);
      
      console.log('char.userDescription_ifaceDesc.name = ' + char.userDescription_ifaceDesc.name);
